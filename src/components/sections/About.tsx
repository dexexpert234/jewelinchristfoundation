      ...
      <div className="grid md:grid-cols-5 gap-10 items-center bg-secondary rounded-3xl p-8 md:p-14">
        <div className="md:col-span-2">
          <div className="relative rounded-2xl overflow-hidden shadow-elegant">
            <img src={leader} alt="Judith Ngozi Agu, Founder" className="w-full h-[420px] object-cover" loading="lazy" width={800} height={1000} />
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-primary/95 to-transparent text-primary-foreground">
                <div className="text-primary-foreground/80 text-xs uppercase tracking-[0.3em] mb-1">Founder</div>
        ...
        <div className="md:col-span-3">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Under the leadership of Judith Ngozi Agu, our Founder, Jewel in Christ Foundation has grown into a movement of restoration — where every program is designed with empathy, expertise, and an unwavering belief in human dignity.
          </p>
          <p className="text-muted-foreground leading-relaxed">
